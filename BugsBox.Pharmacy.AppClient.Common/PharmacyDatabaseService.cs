...
namespace BugsBox.Pharmacy.AppClient.PS
{
    ...
    partial class PharmacyDatabaseService:IPharmacyDatabaseService
    {
        ...
        public int GetSupplyUnitCount(out string message)
        {
            try
            {
                return pharmacyServcie.GetSupplyUnitCount(out message);
            }
            catch (Exception ex)
            {
                HandleException(ex);
            ...
            {
                //Log.Warning(string.Format("结束调用服务方法:int GetSupplyUnitCount(string a,out string message)."));
            }
        }

        public bool EditGSPLiscence(GSPLicense m, out string message)
        {
            try
            {
                return pharmacyServcie.EditGSPLiscence(m, out message);
            }
            catch (Exception ex)
            {
                HandleException(ex);
            ...
            {
                //Log.Warning(string.Format("结束调用服务方法:bool EditGSPLiscence(GSPLicense m, out string message)."));
            }
        }

        public System.Collections.Generic.IEnumerable<BugsBox.Pharmacy.Business.Models.InstInventeryModel> InstStorageQuery(BugsBox.Pharmacy.Business.Models.InstInventoryQueryModel q, out string message)
        {
            try
            {
                return pharmacyServcie.InstStorageQuery(q, out message);
            }
            catch (Exception ex)
            {
                HandleException(ex);
            ...
            {
                //Log.Warning(string.Format("结束调用服务方法:IEnumerable<BugsBox.Pharmacy.Business.Models.InstInventeryModel> InstStorageQuery(BugsBox.Pharmacy.Business.Models.InstInventoryQueryModel q,out string message)."));
            }
        }        
    }

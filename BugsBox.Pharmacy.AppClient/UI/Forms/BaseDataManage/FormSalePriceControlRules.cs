    ...
    public partial class FormSalePriceControlRules : BaseFunctionForm
    {
        ...
        public FormSalePriceControlRules()
        {
            ...
            if (m.RuleType == 0)
            {
                ...
                {
                     RuleType=0,
                     Description = "在销售开票界面中，控制销售价不得低于采购价。客户端销售开票时，器械选择界面中定义的价格无效，以采购价显示当前器械的销售价，销售价格不得低于采购价格，否则无法开票销售。请注意，销售价格不得低于本公司对该品种定义的最低销售价格。",
            ...
            this.comboBox1.SelectedIndexChanged += (s, e) =>
                {
                    ...
                    if (idx == 0) this.label2.Text = "在销售开票界面中，控制销售价不得低于采购价。客户端销售开票时，器械选择界面中定义的价格无效，以采购价显示当前器械的销售价，销售价格不得低于采购价格，否则无法开票销售。请注意，销售价格不得低于本公司对该品种定义的最低销售价格。";
                    if (idx == 1) this.label2.Text = "在销售开票界面中，以器械选择界面中定义的销售价显示当前价格，可低于采购价销售。请注意，销售价格不得低于本公司对于该品种定义的最低销售价格。";
                    if (idx == 2)
                    {
                        this.label2.Text = "在销售开票界面，以采购价的N倍比例显示当前器械销售价格，可以在文本框中填写该比例。器械选择界面中定义的销售价格无效。本规则可低于采购价销售，但不能高于最高定价。请注意，销售价格不得低于本公司对于该品种定义的最低销售价格。";
                    }

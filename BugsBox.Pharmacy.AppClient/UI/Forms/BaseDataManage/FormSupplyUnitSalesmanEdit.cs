...
namespace BugsBox.Pharmacy.AppClient.UI.Forms.BaseDataManage
{
    public partial class FormSupplyUnitSalesmanEdit : BaseFunctionForm
    {
        ...
        private void pictureBox1_MouseDown(object sender, MouseEventArgs e)
        {
            ...
            UI.Forms.BaseDataManage.Form_Photo frm = new BaseDataManage.Form_Photo(1114, this.Entity.Id);
            frm.ShowDialog();
        }
        /// <summary>
        /// 身份证查看或上传
        ...
        {
            if (this.Entity == null) return;
            UI.Forms.BaseDataManage.Form_Photo frm = new BaseDataManage.Form_Photo(1115, this.Entity.Id);

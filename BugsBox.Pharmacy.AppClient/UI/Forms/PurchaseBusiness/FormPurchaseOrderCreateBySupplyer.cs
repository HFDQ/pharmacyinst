        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                if (xmlNode == null)
                {
                    ...
                    var result = MessageBox.Show("需要启用拟供医疗器械过滤功能吗？如果启用，则需要在首营供货企业中填写拟供品种资料，并提交审核。（本功仅能针对生产企业，只提示一次，设置后无提示。）", "提示", MessageBoxButtons.YesNo) == System.Windows.Forms.DialogResult.Yes;
            ...
            if (all == null)
            {
                MessageBox.Show("无该供货商可销售医疗器械，请查询其经营资质是否过期或其经营范围是否正确。");

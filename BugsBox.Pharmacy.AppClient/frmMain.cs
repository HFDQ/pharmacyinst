...
namespace BugsBox.Pharmacy.AppClient
{
    public partial class frmMain : Form
    {
        ...
        public frmMain(User user)
        {
            ...
            ServicesProvider.Instance.PharmacyNotificationCallback.SayedHello += PharmacyNotificationCallback_SayedHello;
        ...
        void PharmacyNotificationCallback_SayedHello(object sender, EventArgs<string> e)
        {

...
{
    [Description("的业务逻辑处理")]
    public partial class AdverseDrugEventBusinessHandler : BaseBusinessHandler<AdverseDrugEvent>
    {
        public AdverseDrugEventBusinessHandler(RepositoryProvider repositoryProvider, IConnectedInfoProvider connectedInfoProvider)
            : base(repositoryProvider.AdverseDrugEventRepository, repositoryProvider, connectedInfoProvider)
        {

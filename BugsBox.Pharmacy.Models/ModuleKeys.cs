...
namespace BugsBox.Pharmacy.Models
{
    ...
    public static class ModuleKeys
    {
        ...
        public const string YPPCSDGL = "医疗器械批次锁定管理[窗体]";
        [CategoryWithIndex("锁定管理", 0)]
        [DescriptionWithIndex(YWYPTJ, 0)]
        public const string YWYPTJ = "疑问医疗器械添加[窗体]";
        [CategoryWithIndex("锁定管理", 0)]
        [DescriptionWithIndex(YPSD, 0)]
        public const string YPSD = "医疗器械锁定[窗体]";
        [CategoryWithIndex("锁定管理", 0)]
        ...
        public const string GFYWY_EDIT = "供方业务员编辑[窗体]";
        [CategoryWithIndex("首营信息管理", 0)]
        [DescriptionWithIndex(GFYWY_Check, 0)]
        public const string GFYWY_Check = "供方业务员审核[窗体]";
        [CategoryWithIndex("首营信息管理", 0)]
        ...
        public const string KHYWY_Check = "客户采购员审核[窗体]";
        [CategoryWithIndex("首营信息管理", 0)]
        ...
        public const string SYYPLR = "首营医疗器械录入[窗体]";
        [CategoryWithIndex("首营信息管理", 0)]
        [DescriptionWithIndex(FORM_DrugInfoImport, 0)]
        public const string FORM_DrugInfoImport = "合格医疗器械导入[窗体]";
        ...
        public const string PTCG = "医疗器械采购[窗体]";
        [CategoryWithIndex("采购业务管理", 0)]
        ...
        public const string CGYPXZ = "采购医疗器械选择[窗体]";
        [CategoryWithIndex("采购业务管理", 0)]
        ...
        public const string DrugOtherInfor = "医疗器械其他信息设置及修改[窗体]";
        ...
        public const string BHGYPXJ = "不合格医疗器械新建[窗体]";
        ...
        [CategoryWithIndex("养护管理", 0)]
        [DescriptionWithIndex(普通养护医疗器械记录, 0)]
        public const string 普通养护医疗器械记录 = "普通养护医疗器械记录[窗体]";
        [CategoryWithIndex("养护管理", 0)]
        [DescriptionWithIndex(重点养护医疗器械记录, 0)]
        public const string 重点养护医疗器械记录 = "重点养护医疗器械记录[窗体]";
        #endregion
        ...
        public const string SpecialDrugApproval = "特殊管理医疗器械二次复核[窗体]";
        ...
        [CategoryWithIndex("仓储管理", 0)]
        [DescriptionWithIndex(YKCX)]
        public const string YKCX = "移库查询[窗体]";
        [CategoryWithIndex("仓储管理", 0)]
        [DescriptionWithIndex(YKSQ, 0)]
        public const string YKSQ = "移库申请[功能]";
        [CategoryWithIndex("仓储管理", 0)]
        [DescriptionWithIndex(YKGLSH, 0)]
        public const string YKGLSH = "移库审批[功能]";
        ...
        public const string DrugInfoApproval = "首营医疗器械审批[窗体]";


        [CategoryWithIndex("首营信息审批", 0)]
        [DescriptionWithIndex(DrugInfoLock, 0)]
        public const string DrugInfoLock = "医疗器械解锁审批[窗体]";
        [CategoryWithIndex("首营信息审批", 0)]
        ...
        public const string DrugInfoEdit = "医疗器械修改审批[窗体]";
        [CategoryWithIndex("首营信息审批", 0)]
        ...
        public const string BHGYPSH = "不合格医疗器械审核[窗体]";
        ...
        public const string DCLYPQK = "待处理医疗器械质管员复核[窗体]";
        [CategoryWithIndex("其他审批审核", 0)]
        [DescriptionWithIndex(DCLYPFHJL, 1)]
        public const string DCLYPFHJL = "待处理医疗器械质管部复核结论[窗体]";
        ...
        public const string BHGYPCX = "不合格医疗器械处理[窗体]";

        [CategoryWithIndex("拒收及不合格管理", 0)]
        [DescriptionWithIndex(YPBSSH, 0)]
        public const string YPBSSH = "医疗器械报损审核[窗体]";
        ...
        public const string YPXXCX = "医疗器械信息查询[窗体]";
        ...
        public const string SHJL = "医疗器械收货记录[窗体]";
        [CategoryWithIndex("采购相关查询", 0)]
        [DescriptionWithIndex(JSJL, 0)]
        public const string JSJL = "医疗器械拒收记录[窗体]";
        [CategoryWithIndex("采购相关查询", 0)]
        [DescriptionWithIndex(YSJL, 0)]
        public const string YSJL = "医疗器械验收记录[窗体]";
        ...
        [CategoryWithIndex("销售相关查询", 0)]
        [DescriptionWithIndex(医疗器械销售记录, 0)]
        public const string 医疗器械销售记录 = "医疗器械销售记录[窗体]";
        ...
        public const string JYFWGL = "医疗器械经营范围管理[窗体]";
        ...
        public const string YWGGGL = "医疗器械规格管理[窗体]";
        [CategoryWithIndex("系统管理", 0)]
        ...
        public const string JXGL = "医疗器械型号管理[窗体]";
        [CategoryWithIndex("系统管理", 0)]
        ...
        #region 功能地图
        [CategoryWithIndex("功能地图", 0)]
        [DescriptionWithIndex(GNDT, 0)]
        public const string GNDT = "功能地图展示[窗体]";
        [CategoryWithIndex("功能地图", 0)]
        [DescriptionWithIndex(YBCGLC, 0)]
        public const string YBCGLC = "一般采购流程[窗体]";
        [CategoryWithIndex("功能地图", 0)]
        [DescriptionWithIndex(YBXSLC, 0)]
        public const string YBXSLC = "一般销售流程[窗体]";
        #endregion

        #region 不良事件监测制度
        [CategoryWithIndex("不良事件监测", 0)]
        [DescriptionWithIndex(BLSJDJ, 0)]
        public const string BLSJDJ = "不良事件登记[窗体]";
        [CategoryWithIndex("不良事件监测", 0)]
        [DescriptionWithIndex(BLSJCX, 0)]
        public const string BLSJCX = "不良事件查询[窗体]";
    ...
    public static class GoodsTypeKeys
    {
        ...
        /// 医疗器械>>国产
        /// </summary>
        public const string DrugDomestic = "医疗器械>>国产";

        /// <summary>
        /// 医疗器械>>进口
        /// </summary>
        public const string DrugImport = "医疗器械>>进口";

...
namespace BugsBox.Pharmacy.ServiceHost.UserControls
{
    public partial class ServiceControl : UserControl
    {
        ...
        bool registerdevicetoremote = bool.Parse(System.Configuration.ConfigurationManager.AppSettings["registerdevicetoremote"].ToString());
        ...
        public ServiceControlButton Button
        {
            get
            {
                return this.serviceControlButton;
            }
        }
        ...
        public Status StartService()
        {
            try
            {
                ...
                {
                    if (registerdevicetoremote)
                    {
                        try
                        {

                            ProductKeyVerifyService.Instance.Launch();

                            LoggerHelper.Instance.Information("success");
                        }
                        catch (Exception ex)
                        {

...
namespace BugsBox.Pharmacy.ServiceHost
{
    ...
    public partial class mainForm : Form
    {
        ...
        bool autostart = bool.Parse(System.Configuration.ConfigurationManager.AppSettings["autoStart"].ToString());
        ...
        private void 注册产品ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            VerifyPrdKey verifyPrdKeyFrm = new VerifyPrdKey();
            verifyPrdKeyFrm.ShowDialog();
        }
